            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary">
                        ...
                        <form action="<?= BASE_URL_ADMIN . '/?act=edit-danh-muc' ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="mo_ta" class="form-control" placeholder="Nhập mô tả danh mục"><?= $danhMuc['mo_ta'] ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Hình Ảnh</label>
                                    <input type="file" class="form-control" name="hinh_anh">
                                    <?php if (!empty($danhMuc['hinh_anh'])) { ?>
                                        <img src="<?= BASE_URL . '/uploads/' . $danhMuc['hinh_anh'] ?>" alt="Hình ảnh danh mục" style="width: 150px; height: auto; margin-top: 10px;">
                                    <?php } ?>
                                </div>
                            </div>
                            <!-- /.card-body -->
